...
# replace the model_name with any of the following:
# 'chi2024/xlm-roberta-large-binary-cs-iib'
# 'chi2024/xlm-roberta-xl-binary-cs-iib'
# 'chi2024/robeczech-base-binary-cs-iib'
# 'chi2024/small-e-czech-binary-cs-iib'
# 'chi2024/xlm-roberta-large-binary-en-iib'
model_name = 'chi2024/xlm-roberta-large-binary-cs-iib'
