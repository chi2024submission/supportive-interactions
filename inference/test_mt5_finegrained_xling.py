...
(train_texts, train_text_pairs, train_labels,
 ...
 test_texts, test_text_pairs, test_labels) = read_split_data('chi2_128_en_02c', Path('data/v3'), "1",
                                                                   granularity="seq_multi")
# (train_texts, train_text_pairs, train_labels,
#  dev_texts, dev_text_pairs, dev_labels,
#  test_texts, test_text_pairs, test_labels) = read_split_data('chi2_128_02c', Path('data/v3'), "1",
#                                                                    granularity="seq_multi")
...
checkpoint_path = "trained_models/lilac-deluge-16-seq_multi_02c"
# checkpoint_path = "trained_models/astral-morning-19-seq_multi_en_02c"
test_batch_size = 32
...
for fscore_method in ["weighted", "micro", "macro"]:
    ...
    print("Finegrained-seq xling F-scores (%s) interval: (%s; %s), mean: %s" % (fscore_method, lower, upper, mean))
