...
checkpoint_path = "trained_models/earnest-rain-17-seq_coarse_02c"
checkpoint_path = "trained_models/dandy-wildflower-18-seq_coarse_en_02c"
test_batch_size = 32
...
for fscore_method in ["weighted", "micro", "macro"]:
    ...
    print("Coarse-seq xling F-scores (%s) interval: (%s; %s), mean: %s" % (fscore_method, lower, upper, mean))
